        ...
        <header className="md:hidden sticky top-0 z-40 bg-bg-surface/90 backdrop-blur-xl border-b border-border-subtle px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl border transition-all active:scale-95 focus-ring ${isRouteActive("leaderboard")
                  ...
                  return (
                    ...
                    >
                      <Link
                        ...
                        className={`relative flex items-center gap-3 px-3 py-2.5 rounded-xl text-[13px] font-semibold transition-all duration-200 group focus-ring ${active
                      ...
                      >
                        ...
                        {active && (
                          <motion.div
                            ...
                            className={`absolute inset-0 rounded-xl ${isCourses
                        ...
                        {active && (
                          <motion.div
                            ...
                            className={`absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-5 rounded-r-full ${isCourses ? "bg-brand-mint" : "bg-white/60"
                              }`}
                            transition={{ type: "spring", stiffness: 350, damping: 30 }}
                          />
                        )}
