      ...
      {!purchased && String(course.type || "").trim().toLowerCase() === "recording" ? (
        ...
        >
          <div className="flex items-start gap-3 min-w-0">
            ...
            <div>
              <h2 className="text-sm font-bold text-brand-mint">First 2 Chapters Unlocked</h2>
              <p className="mt-1 text-xs font-medium text-text-muted leading-relaxed">
                First 2 chapters are defaultly unlocked for all students. Click Chapter 1 or Chapter 2 below to start watching!
              </p>
            </div>
          </div>
